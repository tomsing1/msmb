...
source("../chapter-setup.R"); chaptersetup("/home/msmith/Projects/CUBook/Chap3-Graphics/rgraphics.Rnw", "3")
...
## ----theme_bw, fig.width = 3, fig.height = 3-----------------------------------------------------------------------------------
...
## ---- xkcdgraph, eval = TRUE, echo = FALSE, fig.show = 'hold', fig.keep = 'high'-----------------------------------------------
