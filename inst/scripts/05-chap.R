...
source("../chapter-setup.R"); chaptersetup("/home/msmith/Projects/CUBook/Chap6-Clustering/Cluster.Rnw", "5")
...
## ----kmeanspital1, fig.keep = 'high', fig.show = "hold", fig.cap = "An example of non-convex clusters. On the left we show the result of $k$-means clustering with $k=2$. On the right we have the output from `dbscan`. The colors represent the three clusters found by the algorithm for the settings \\texttt{eps = 0.16, minPts = 3}.", fig.margin = FALSE, out.width = '50%', echo=FALSE----
library("kernlab")
data("spirals")
