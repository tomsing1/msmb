...
source("../chapter-setup.R"); chaptersetup("/home/msmith/Projects/CUBook/Chap9-MVA2/MDSCA.Rnw", "9")
...
## ----chap9-r-ekmannonMDS-1, fig.keep = 'high', fig.show = "hold", fig.cap = "Comparison of the output from the classical multidimensional scaling on the left (same as Figure \\@ref(fig:chap9-r-ekmanMDS-1)) and the nonmetric version on the right.", fig.margin = FALSE, out.width = '50%', fig.width = 4.6, fig.height = 4.5, echo=-(1:2)----
ggplot(dfekm, aes(x = MDS1, y = MDS2)) +
  geom_point(col = dfekm$rgb, size = 4) +
  geom_text_repel(aes(label = name)) + coord_fixed()
...
## ----platoca, fig.keep = 'high', fig.cap = "Biplot of Plato\'s sentence endings."----------------------------------------------
...
## ---- dmap134, eval = TRUE, echo = FALSE, fig.show = 'hold', fig.keep = 'high', fig.cap = "Ouput from a three-dimensional diffusion map projection."----
