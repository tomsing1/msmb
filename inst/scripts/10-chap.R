...
source("../chapter-setup.R"); chaptersetup("/home/msmith/Projects/CUBook/Chap11-NetworksTrees/Graphs.Rnw", "11")
...
## ---- Magnify, eval = TRUE, echo = FALSE, fig.show = 'hold', fig.keep = 'high'-------------------------------------------------
knitr::include_graphics(c('images/Magnify.png'))
