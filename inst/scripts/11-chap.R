...
source("../chapter-setup.R"); chaptersetup("/home/msmith/Projects/CUBook/Chap13-ImageAnalysis/ImageAnalysis.Rnw", "13")
...
knitr::include_graphics(c('images/Rain-Drops-small.jpg'))
